...
local DEFAULT_CONFIG = {
	...
	colors = require("mountain.palette"),
	overrides = {},
}
...
---load mountain colorscheme
local function load()
	if vim.version().minor < 7 then
		vim.notify_once("mountain.nvim: you must use neovim 0.7 or higher")
		return
	end
